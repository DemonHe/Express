			...
			if (e.getSource() == button_confirm) {
				...
				if (complete) {
					...
					if (ttd.addTransferDoc(vo)) {
						TipBlock block=new TipBlock("生成中转单成�?");
						tippane.add(block);
						block.show();
						block=null;
						ttd.endTransferDoc();
