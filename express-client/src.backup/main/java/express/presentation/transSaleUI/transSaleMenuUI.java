...
public class transSaleMenuUI extends JPanel {
	...
	private MySideLabel button_shipment = new MySideLabel("生成装车�?");
	private MySideLabel button_transfer = new MySideLabel("生成中转�?");
	...
	public transSaleMenuUI(MainUIService m, String id) {
		...
		button_arrival.addMouseListener(listener);// 加监�?
		...
		button_transfer.addMouseListener(listener);// 加监�?
