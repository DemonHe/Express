...
public class AdminAddUI extends JDialog {
	...
	private String getPosition(UserRole role){
		switch(role){
		case DeliverMan: return "快�?�员";
		case Admin:return "管理�?";
		case Manager:return "总经�?";
		case Financial:return "普�?�财务人�?";
		case Financial_highest:return "�?高权限财务人�?";
		case TransCenterRepo:return "中转中心仓库管理人员";
		case TransCenterSale:return "中转中心业务�?";
	...
	private UserRole getPosition(String s){
		switch(s){
		case "快�?�员": return UserRole.DeliverMan;
		case "管理�?":return UserRole.Admin;
		case "总经�?":return UserRole.Manager;
		case "普�?�财务人�?":return UserRole.Financial;
		case "�?高权限财务人�?":return UserRole.Financial_highest;
		case "中转中心仓库管理人员":return UserRole.TransCenterRepo;
		case "中转中心业务�?":return UserRole.TransCenterSale;
