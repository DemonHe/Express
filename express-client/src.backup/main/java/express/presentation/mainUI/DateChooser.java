...
public class DateChooser extends JPanel{
  ...
  //  private JP4 jp4;  
    ...
    public DateChooser(Date date){  
       this(date, "yyyy年MM月dd�?");  
    }  
    public DateChooser(String format,JTextField textfield){  
...
//    	 this.setPreferredSize(new Dimension(70,70));  
        showDate=new JLabel();  
        ImageIcon c = new ImageIcon("picture/icon1.png");
        showDate.setIcon(c);
...
//		ImageIcon background = new ImageIcon("picture/icon1.png");
